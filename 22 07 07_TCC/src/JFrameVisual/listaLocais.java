...
public class listaLocais extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1EDITAR_LOCAL = new javax.swing.JButton();
        ...
        jButton1EDITAR_LOCAL.setText("editar local");
        jButton1EDITAR_LOCAL.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1EDITAR_LOCALActionPerformed(evt);
            }
        });

        jButton2REMOVER_LOCAL.setBackground(new java.awt.Color(255, 51, 0));
        jButton2REMOVER_LOCAL.setText("REMOVER LOCALIZACAO");
        jButton2REMOVER_LOCAL.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2REMOVER_LOCALActionPerformed(evt);
            }
        });

        jButton3ADICIONAR_LOCAL.setBackground(new java.awt.Color(0, 153, 0));
        jButton3ADICIONAR_LOCAL.setText("ADICIONAR LOCAL");
        jButton3ADICIONAR_LOCAL.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton3ADICIONAR_LOCALActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(48, 48, 48)
                .addComponent(jButton3ADICIONAR_LOCAL)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 258, Short.MAX_VALUE)
                .addComponent(jButton1EDITAR_LOCAL)
                .addGap(197, 197, 197)
                .addComponent(jButton2REMOVER_LOCAL)
                .addGap(78, 78, 78))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listaLocais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new listaLocais().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify                     
    private javax.swing.JButton jButton1EDITAR_LOCAL;
    private javax.swing.JButton jButton2REMOVER_LOCAL;
    private javax.swing.JButton jButton3ADICIONAR_LOCAL;
